...
export YARN_OPTS="-Dfile.encoding=utf-8 -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.port=1098 -Dcom.sun.management.jmxremote.rmi.port=1098";
yarn jar ./target/scarecrow-lucene-services-app.jar com.factual.lucene.scarecrow.ScarecrowIndexServer
